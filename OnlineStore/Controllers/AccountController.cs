...
namespace OnlineStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //var roleStore = new RoleStore<IdentityRole>(new OnlineStoreDbContext());
                    //var rolManager = new RoleManager<IdentityRole>(roleStore);
                    //await rolManager.CreateAsync(new IdentityRole(nameof(Roles.Admin)));
                    //await UserManager.AddToRoleAsync(user.Id, nameof(Roles.Admin));
        ...
        {
            var userID = _context.Users.Where(i => i.UserName == user.UserName).Select(x => x.Id);
            var updatedId = "";
            foreach (var item in userID)
            {
                updatedId = item.ToString();
            }
            //assign Roles
